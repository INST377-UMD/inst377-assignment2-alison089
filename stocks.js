...
function fetchRedditStocks() {
  ...
  fetch(`https://tradestie.com/api/v1/apps/reddit?date=${today}`)
    ...
    .catch((error) => {
      ...
      document.querySelector("#reddit-stocks tbody").innerHTML =
        '<tr><td colspan="3">Error loading Reddit stocks</td></tr>';
    });
}

document.addEventListener("DOMContentLoaded", function () {
  document
    .getElementById("lookup-stock")
    .addEventListener("click", lookupStock);
